...
<body>
  ...
  <?php
    if (isset($_POST['btnSimpan'])) {
      ...
      // Refresh form
      echo "<meta http-equiv='refresh' content='0; url=?idkk=$idkk&status=Data Sudah Keluar'>";
    }
  ?>
  <form id="form1" name="form1" method="post" action="">
    <?php
      $q_tbladm   = mysqli_query($con, "SELECT * FROM `tbl_adm` WHERE nokk = '$_GET[idkk]' AND nodemand = '$_GET[demand]'");
      $d_tbladm   = mysqli_fetch_assoc($q_tbladm);
    ?>
    <input type="hidden" value="<?= $d_tbladm['id']; ?>" name="id">
    <table width="100%" border="0">
      ...
      <tr>
        ...
        <td width="1%">:</td>
        <td><input name="lebar" type="text" id="lebar" size="6" value="<?= floor($dt_lg['LEBAR']); ?><?php if ($cek > 0) {
      ...
      <tr>
        ...
        <td width="1%">:</td>
        <td><input name="qty" type="text" id="qty" size="8" value="<?= $dt_qtyorder['QTY_ORDER']; ?><?php if ($cLot > 0) {
                                                                      echo $sLot['Weight'];
                                                                    } else {
                                                                      echo $rw['qty'];
                                                                    } ?>" placeholder="0.00" />
      ...
      <tr>
        ...
        <td>:</td>
        <td><input name="warna" type="text" id="warna" size="35" value="<?= $dt_warna['WARNA']; ?><?php if ($cek > 0) {
                                                                          echo $ssr['color'];
                                                                        } else {
                                                                          echo $rw['warna'];
                                                                        } ?>" /></td>
        ...
        <td>:</td>
        <td><input name="qty2" type="text" id="qty2" size="8" value="<?= $dt_qtyorder['QTY_ORDER_YARD']; ?><?php echo $rw['panjang']; ?>" placeholder="0.00" onFocus="jumlah();" />
          <strong>Yard</strong>
        </td>
      </tr>
      <tr>
