		...
		<table width="100%" border="0">
			...
			<tr>
				...
				<td>
					...
					<input name="lebar" type="text" id="lebar" size="6" value="<?= floor($dt_lg['LEBAR']); ?><?= $nlebar; ?>" placeholder="0" />
					&quot; X
					<?php if ($cek > 0) {
						$ngramasi = $ssr['weight'];
					} else {
					...
					<input name="gramasi" type="text" id="gramasi" size="6" value="<?= floor($dt_lg['GRAMASI']); ?><?= $ngramasi; ?>" placeholder="0" />
				</td>
			</tr>
			<tr>
				...
				<td>
					...
					<input name="qty" type="text" id="qty" size="8" value="<?= $dt_qtyorder['QTY_ORDER']; ?><?= $berat; ?>" placeholder="0.00" />
					<strong>Kg</strong>
				</td>
			</tr>
			<tr>
